  ...
  const recentPatients = [
    {
      ...
      name: "Aisha Mohammed",
      module: "Consultation",
      time: "2026-03-08 08:42:15",
      status: "Seen",
      statusStyle: "bg-[#EBF7F2] text-[#2A6543]",
    },
    {
      id: "PAT-PLT-000234",
      name: "Aisha Mohammed",
      module: "Laboratory",
      time: "2026-03-08 08:31:02",
      status: "Waiting",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-white rounded-[20px] p-6 shadow-sm border border-gray-100 flex flex-col items-center relative">
            ...
            <div className="w-full flex justify-center gap-4 mb-8 text-[11px] text-gray-500 font-medium">
              ...
              <div className="flex items-center gap-1.5">
                <span className="w-2 h-2 rounded-full bg-[#68D391]"></span>Lab
                Test
              </div>
              <div className="flex items-center gap-1.5">
            ...
            <div
              ...
              style={{
                background:
                  "conic-gradient(#2A6543 0% 55%, #68D391 55% 70%, #FDBA74 70% 100%)",
              }}
            >
            ...
            <div className="space-y-5 flex-1">
              {diseasesData.map((disease, idx) => (
                <div key={idx} className="flex items-center gap-4">
                  <span className="text-xs text-gray-600 font-medium w-[120px] truncate">
                    {disease}
                  </span>
                  <div className="flex-1 h-3 bg-gray-100 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-[#2A6543] rounded-full"
                      style={{ width: "80%" }}
                    ></div>
                  </div>
                ...
                {recentPatients.map((patient, index) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-6">
                      <span
                        className={`px-3 py-1 rounded-full text-[11px] font-bold ${patient.statusStyle}`}
                      >
                        {patient.status}
                      </span>
                    </td>
                    <td className="py-4 px-6">
                      <button
                        onClick={() =>
                          handleAction(`View Patient: ${patient.name}`)
                        }
