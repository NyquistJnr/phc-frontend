...
const navItems = [
  { name: "Dashboard", icon: LayoutDashboard, path: "/oic-dashboard" },
  { name: "Reports", icon: Users, path: "/oic-dashboard/reports" },
  { name: "Patient Records", icon: Stethoscope, path: "/oic-dashboard/patient-records" },
  { name: "Facility Monitoring", icon: FlaskConical, path: "/oic-dashboard/facility-monitoring" },
  { name: "Staff Overview", icon: Pill, path: "/oic-dashboard/staff-overview" },
];
