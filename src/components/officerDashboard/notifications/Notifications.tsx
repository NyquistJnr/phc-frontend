...
const INITIAL_NOTIFICATIONS = [
  {
    id: "OIC-NOT-001",
    title: "Facility report pending",
    message: "Monthly malaria report is awaiting review.",
    time: "12:24 PM",
    read: false,
  },
  {
    ...
    message: "Laboratory activity summary has been updated.",
    time: "9:14 AM",
    read: true,
  },
];
      ...
      <div className="px-4 py-6 sm:px-6 lg:py-8">
        <div className="mb-6">
          ...
          <p className="mt-2 text-base text-[#3F3F46]">
            Review facility alerts and operational updates.
          </p>
        </div>
