    ...
    <div className="flex-1 flex flex-col bg-[#F9FAFB]">
      ...
      <div className="flex-1 px-4 sm:px-8 pt-4 pb-10 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          <div>
            <h2 className="text-3xl font-medium font-inter text-gray-900 tracking-tight">
              Welcome Nobert
            </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-8 rounded-[32px] shadow-sm border border-gray-100">
            <div className="mb-6">
              <h3 className="text-lg font-bold text-[#101928]">
                System Status
              </h3>
                  ...
                  >
                    ...
                    <td className="px-6 py-5">
                      <div className="flex justify-center">
                        <span
                          className={`${log.statusColor} px-3 py-1 rounded-full text-[10px] font-bold`}
                        >
                          {log.status}
                        </span>
                      </div>
...
>>>>>>> 49ce97ecb14b35d85864f8e78b531b0630a7c476
        </div>
