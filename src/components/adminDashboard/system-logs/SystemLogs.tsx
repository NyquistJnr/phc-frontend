      ...
      <div className="p-4 sm:p-8">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4 mb-6 sm:mb-8">
          <div>
            ...
            <p className="text-gray-600">Monitor system errors, security warnings, and platform issues</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-[#2A6543] rounded-2xl p-6 shadow-sm text-white relative overflow-hidden">
            ...
            <h3 className="text-[32px] font-bold leading-none">18</h3>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <h3 className="text-[32px] font-bold text-gray-900 leading-none">4</h3>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <h3 className="text-[32px] font-bold text-gray-900 leading-none">9</h3>
          </div>

          {/* Resolved */}
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 relative">
            <div className="absolute top-6 right-6 flex items-center gap-1 text-xs text-gray-400 font-medium cursor-pointer">
            ...
            <h3 className="text-[32px] font-bold text-gray-900 leading-none">5</h3>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="p-4 sm:p-6 flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-gray-50">
            <h3 className="font-bold text-gray-900 text-[17px]">Log Entries</h3>
            ...
            <div className="flex flex-wrap items-center gap-3">
              <div className="relative">
                ...
                <input 
                  ...
                  placeholder="Search..." 
                  className="pl-9 pr-4 py-2 bg-white border border-gray-200 rounded-lg text-sm w-full sm:w-[200px] focus:outline-none focus:border-gray-300"
                />
              </div>
