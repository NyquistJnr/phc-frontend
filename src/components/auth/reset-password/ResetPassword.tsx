...
function ResetPasswordForm() {
  ...
  useEffect(() => {
    if (!uid || !token) {
      toast.warning(
        "Warning: The password reset link appears to be invalid or missing parameters.",
        {
          toastId: "missing-token-warning",
        },
      );
    }
  }, [uid, token]);
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="mb-8">
        <div className="w-14 h-14 bg-[#F0FDF4] rounded-2xl flex items-center justify-center mb-6 border border-[#DCFCE7]">
          <Lock size={28} className="text-[#046C3F]" />
        </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              disabled={!uid || !token || resetPasswordMutation.isPending}
