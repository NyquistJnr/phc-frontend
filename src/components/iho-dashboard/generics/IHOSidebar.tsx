...
const navItems = [
  { name: "Dashboard", icon: LayoutDashboard, path: "/iho-dashboard" },
  { name: "Patients", icon: Users, path: "/iho-dashboard/patients" },
  {
    name: "Appointments",
    icon: CalendarDays,
    path: "/iho-dashboard/appointments",
  },
  { name: "Referrals", icon: Share2, path: "/iho-dashboard/referrals" },
];

export const IHOSidebar = () => {
