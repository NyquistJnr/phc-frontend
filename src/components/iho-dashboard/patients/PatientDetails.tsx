...
import type { PatientReferral } from "@/src/components/iho-dashboard/patients/type";
    ...
    <GenericTable
      ...
      columns={[
        ...
        { header: "Notes", accessorKey: "notes", sortable: true },
        {
          ...
          render: (row) => (
            <Link
              href={`/iho-dashboard/appointments/${row.rawId}`}
    ...
    <GenericTable
      ...
      columns={[
        ...
        },
        {
          ...
          render: (row) => (
            <Link
              href={`/iho-dashboard/lab/${row.rawId}`}
              className="text-[#046C3F] font-medium hover:underline"
            >
              View
            </Link>
    ...
    <GenericTable
      ...
      columns={[
        ...
        },
        {
          ...
          render: (row) => (
            <Link
              href={`/iho-dashboard/meds/${row.rawId}`}
              className="text-[#046C3F] font-medium hover:underline"
            >
              View
            </Link>
  ...
  const items = [
    {
      label: "View Detail",
      icon: Eye,
      onClick: () => router.push(`/iho-dashboard/referrals/${row.id}`),
  ...
  return (
    <>
      <NurseDashboardHeader
        title="Patients"
        breadcrumbs={[
          { label: "Patients", href: "/iho-dashboard/patients" },
          { label: "View Profile" },
        ]}
      />
