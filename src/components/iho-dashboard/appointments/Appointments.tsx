...
export default function Appointments() {
  ...
  const columns: ColumnDef<AppointmentResult>[] = [
    ...
    { header: "Reason", accessorKey: "reason_for_visit", sortable: true },
    {
      ...
      sortable: true,
      render: (row) => row.assigned_staff_name || "Unassigned",
    },
    {
      header: "Assigned For Vitals",
      accessorKey: "assigned_for_vitals_name",
      sortable: true,
      render: (row) => row.assigned_for_vitals_name || "Unassigned",
    },
    {
      header: "Status",
      render: (row) => {
