...
export function DataTable<T>({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 w-full flex flex-col">
            ...
            {showSearch && (
              <div className="relative w-full sm:w-auto sm:max-w-md flex-1">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0a6c38]/20 focus:border-[#0a6c38] w-full transition-all"
                />
              </div>
            )}
