...
import { DeliveryResult } from "@/src/components/chewDashboard/maternal-care/type";
  ...
  const items = [
    {
      ...
      icon: Eye,
      onClick: () =>
        router.push(`/chew-dashboard/maternal-care/delivery/${row.id}`),
    ...
    },
    {
      ...
      icon: Eye,
      onClick: () =>
        router.push(`/chew-dashboard/maternal-followups/${row.episode_uuid || row.episode_id}`),
      className: "text-[#046C3F]",
    },
  ];
