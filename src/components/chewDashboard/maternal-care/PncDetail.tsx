      ...
      <ChewDashboardHeader
        ...
        breadcrumbs={[
          ...
          },
          {
            ...
            href: `/chew-dashboard/maternal-followups/${episodeId}`,
          },
      ...
      <div className="px-4 py-6 sm:px-6 lg:py-8 max-w-8xl mx-auto">
        ...
        <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <Link
              href={`/chew-dashboard/maternal-followups/${episodeId}/pnc/${pncId}/birth`}
            ...
            <Link
              href={`/chew-dashboard/maternal-followups/${episodeId}/pnc/${pncId}/new`}
