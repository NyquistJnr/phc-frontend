    ...
    <div className="min-h-screen bg-[#F6F7FC]">
      ...
      <div className="px-4 py-6 sm:px-6 lg:py-8 max-w-8xl mx-auto">
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <button
            onClick={() => router.push("/chew-dashboard/appointments")}
          ...
          <div className="flex items-center gap-3">
            ...
            {isLoadingReferrals ? (
              ...
              <button
                onClick={() =>
                  router.push(
                    `/chew-dashboard/referrals/${existingReferral.id}`,
                  )
                }
              ...
              <button
                onClick={() => router.push(`/chew-dashboard/referrals/new?appointment=${id}`)}
          ...
          <div className="md:col-span-3 bg-white rounded-2xl border border-gray-100 p-6 shadow-sm">
            <div className="mb-6 flex items-center justify-between border-b border-gray-100 pb-4">
              ...
              {!isLoadingVitals && (
                <button
                  onClick={() =>
                    router.push(`/chew-dashboard/vitals/new/${id}`)
                  }
