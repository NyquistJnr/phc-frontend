...
export default function DispensePrescriptionModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] overflow-y-auto bg-black/40 px-4 py-10 backdrop-blur-sm">
      <div className="mx-auto w-full max-w-2xl rounded-xl bg-white px-6 py-8 shadow-2xl">
        ...
        <div className="mb-6 grid grid-cols-1 gap-3 rounded-lg bg-[#F6F7FC] p-4 text-sm text-gray-600 sm:grid-cols-2">
          ...
          <div>
            ...
            <span className="font-medium text-gray-900">{order.priority}</span>
          </div>
        </div>
