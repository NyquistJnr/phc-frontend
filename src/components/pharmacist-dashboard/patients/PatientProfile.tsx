...
import PharmacistDateRangeFilter from "@/src/components/pharmacist-dashboard/generics/PharmacistDateRangeFilter";
  ...
  return (
    <>
      <PharmacistDashboardHeader
        title="Patients"
        breadcrumbs={[
          { label: "Patients", href: "/pharmacist-dashboard/patients" },
          { label: "View Profile" },
        ]}
      />
      <div className="px-4 py-6 sm:px-6 lg:py-8">
        <Link
          href="/pharmacist-dashboard/patients"
