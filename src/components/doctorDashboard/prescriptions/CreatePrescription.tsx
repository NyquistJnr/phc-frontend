...
export default function CreatePrescription() {
  ...
  const { data: inventoryData, isFetching: isLoadingDrugs } =
    useInventoryDrugs(drugSearch);
  ...
  const inventoryOptions = (inventoryData || []).map((item: any) => ({
                    ...
                    <div className="col-span-1 space-y-6 md:col-span-3 lg:col-span-1">
                      <SelectField
                        ...
                        onChange={(val) => {
                          ...
                          // Clear custom drug if inventory item is selected
                          if (val) {
                            handleMedicationChange(
                              item.id,
                              "custom_drug_name",
                      ...
                      {!item.inventory_item && (
                        <FieldShell label="Or Custom Drug Name">
                          <input
                            value={item.custom_drug_name}
                            onChange={(e) =>
                              handleMedicationChange(
                                item.id,
                                "custom_drug_name",
