...
import type { AppointmentResult } from "@/src/components/nurse-dashboard/appointments/type";
  ...
  const items = [
    {
      label: "View Detail",
      icon: Eye,
      onClick: () => router.push(`/doctor-dashboard/appointments/${row.id}`),
    ...
    <div className="min-h-screen bg-[#F6F7FC]">
      ...
      <div className="px-4 py-6 sm:px-6 lg:py-8">
        <div className="mb-7 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          ...
          <Link
            href="/doctor-dashboard/appointments/new"
