...
type VitalValue = string | number | null | undefined;
...
type AppointmentVital = {
  ...
  blood_pressure?: VitalValue;
  pulse_rate?: VitalValue;
  temperature?: VitalValue;
  respiratory_rate?: VitalValue;
  weight_kg?: VitalValue;
  height_cm?: VitalValue;
  bmi?: VitalValue;
  spo2?: VitalValue;
  notes?: string;
};
        ...
        {[
          ...
          <div key={field.name}>
            ...
            <input
              ...
              name={field.name}
              value={formData[field.name as keyof VitalFormData] ?? ""}
...
export default function AppointmentDetails() {
  ...
  const allVitals = (vitalsData?.results || []) as AppointmentVital[];
  ...
  return (
    <div className="min-h-screen bg-[#F6F7FC]">
      <DoctorHeader
        ...
        breadcrumbs={[
          { label: "Appointments", href: "/doctor-dashboard/appointments" },
          ...
          <div className="flex items-center gap-3">
            ...
            {isLoadingReferrals ? (
              ...
              <button
                onClick={() =>
                  router.push(
                    `/doctor-dashboard/referrals/${existingReferral.id}`,
                  )
                }
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-100">
                    ...
                    {showPastVitals && (
                      <div className="mt-6 space-y-6">
                        {pastVitals.map((pastVital, index) => (
                          <div
