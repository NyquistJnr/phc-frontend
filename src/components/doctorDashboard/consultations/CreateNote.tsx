  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    createConsultation(payload, {
      onSuccess: (response) => {
        ...
        router.push(id ? `/doctor-dashboard/consultations/${id}` : "/doctor-dashboard/consultations");
      },
      onError: (error) => {
        setFormError(getApiErrorMessage(error, "Failed to save consultation note."));
      },
    });
  };
      ...
      <div className="px-4 py-6 sm:px-6 lg:py-8">
        ...
        >
          <div className="mb-8 flex items-center gap-3">
            ...
            <h2 className="text-xl font-semibold text-black">Consultation Note</h2>
          </div>
          ...
          <div className="max-w-4xl space-y-6">
            ...
            <TextareaField
              ...
              onChange={(value) => updateField("history_of_present_complaint", value)}
            />
            <TextareaField
