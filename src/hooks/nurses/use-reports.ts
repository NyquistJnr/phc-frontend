...
export const useVitalSignsReport = (params: NursePaginatedReportParams) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const data = await api.get<VitalSignsResponse>(`/reports/nurse/vital-signs/?${searchParams.toString()}`);
      return data;
    },
    staleTime: 5 * 60 * 1000,
  });
...
export const useImmunizationReport = (params: NursePaginatedReportParams) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const data = await api.get<ImmunizationResponse>(`/reports/nurse/immunization/?${searchParams.toString()}`);
      return data;
    },
    staleTime: 5 * 60 * 1000,
  });
...
export const usePncReport = (params: NursePaginatedReportParams) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const data = await api.get<PNCReportResponse>(`/reports/nurse/postnatal-care/?${searchParams.toString()}`);
      return data;
    },
    staleTime: 5 * 60 * 1000,
  });
...
export const useMaternalCareReport = (params: NursePaginatedReportParams) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const data = await api.get<MaternalCareResponse>(`/reports/nurse/maternal-care/?${searchParams.toString()}`);
      return data;
    },
    staleTime: 5 * 60 * 1000,
  });
...
export const useFollowUpsReport = (params: NursePaginatedReportParams) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const data = await api.get<FollowUpsResponse>(`/reports/nurse/follow-ups/?${searchParams.toString()}`);
      return data;
    },
    staleTime: 5 * 60 * 1000,
  });
...
export const useHealthEducationReport = (params: NursePaginatedReportParams) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const data = await api.get<HealthEducationResponse>(`/reports/nurse/health-education/?${searchParams.toString()}`);
      return data;
    },
    staleTime: 5 * 60 * 1000,
  });
